...
contract HelloWorldDeployer is Script, Test {
    ...
    function run() external {
        ...
        helloWorldDeployment = HelloWorldDeploymentLib.deployContracts(proxyAdmin, coreDeployment, quorum, rewardsInitiator, rewardsOwner);
    ...
    function verifyDeployment() internal view {
        ...
        require(helloWorldDeployment.helloWorldServiceManager != address(0), "HelloWorldServiceManager address cannot be zero");
